...
(function() {
	 ...
	 * @static
	 **/
	platypus.version = /*=version*/"0.3.0"; // injected by build process
	 ...
	 * @static
	 **/
	platypus.buildDate = /*=date*/"Fri, 17 Jul 2015 21:26:22 GMT"; // injected by build process
 ...
 * 
 * @class "collision-tiles" Component
 * @uses Component
 */
            ...
            "load": function () {
                ...
                if (entities) {
                    for (i = 0; i < entities.length; i++) {
                        ...
                        for (j in entities[i]) {
                            if (entities[i].hasOwnProperty(j)) {
                                if (j === 'properties') {
                                    for (k in entities[i].properties) {
                                        if (entities[i].properties.hasOwnProperty(k)) {
                        ...
                        this.owner.triggerEvent('entity-created', this.addEntity(new platypus.Entity(entities[i].id ? entities[i] : platypus.game.settings.entities[entities[i].type], definition)));
                    }
                }
            },
